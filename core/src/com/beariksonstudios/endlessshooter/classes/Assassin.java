...
public class Assassin extends StockClass {

	public Assassin(boolean local, Player player, Vector2 startPos, World physicsWorld, float scale, Camera camera) {
	...
	public void fire() {
		if (bulletCount > 0) {
			...
			Shruiken shruiken = new Shruiken(dir, gunPos, world, scale, degAngle, this);
			bArray.add(shruiken);
			bulletCount -= 1;
		}
	}
